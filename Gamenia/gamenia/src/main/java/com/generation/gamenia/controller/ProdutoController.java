...
import com.generation.gamenia.model.Produto;
import com.generation.gamenia.repository.CategoriaRepository;
import com.generation.gamenia.repository.ProdutoRepository;
...
public class ProdutoController {
    ...
    public ResponseEntity<List<Produto>> getByBrand(@PathVariable String distribuidora) {
        return ResponseEntity.ok(produtoRepository.findAllByDistribuidoraContainingIgnoreCase(distribuidora));
    }
